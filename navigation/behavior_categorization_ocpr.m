...
[h p ci stats]=ttest2(nansum(behavior_indice_mat_ocpr(:,:,3)==1,2),nansum(behavior_indice_mat_control(:,:,3)==1,2));
...
subplot(4,6,19)
avg_ei_obj_exp=nanmean(behavior_indice_mat_ocpr(:,:,9),1);
ste_ei_obj_exp=nanstd(behavior_indice_mat_ocpr(:,:,9))/sqrt(16);
...
save('behavior_indices_ocpr.mat')
