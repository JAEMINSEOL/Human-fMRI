...
%     cd(strcat('subject_',num2str(iS)));
    ...
    for iT=1:1:40
        ...
        switch frame_num.adj_ocpr_num(iT,36);
            ...
            case 6
                place_for_this_trial=4;
            case 9
                place_for_this_trial=5;
            case 12
                place_for_this_trial=2;
            otherwise
...
%      
%                 
%         filename_ai=strcat('epoch2_target_aligned_rotation_subj_',num2str(iS),'_',num2str(iT+100),'.tiff');
%         saveas(gcf,filename_ai);
%         hold off
% 
%      end
%         filename_ai=strcat('epoch2_target_aligned_rotation_subj_',num2str(iS),'.tiff');
%         saveas(gcf,filename_ai);
%     
end
